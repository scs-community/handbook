...
1. [Supplier & Procurement Assurance](../practices-controls/supplier-procurement-assurance.md)  
   Understand the recurring supplier-selection, contracting, review, renewal, and continued-use practice.
2. [Supplier Questions](../resources/supplier-questions.md)  
...
4. [Evidence Maturity Model](../resources/evidence-maturity-model.md)  
   Distinguish unsupported claims from produced, verifiable, and lifecycle-retained evidence.
5. [Evidence Package Template](../resources/evidence-package-template.md)  
   Assemble the review into a reusable evidence package.
6. [Supplier Onboarding Evidence Package](../resources/worked-examples/supplier-onboarding-evidence-package.md)  
   See what a stronger supplier response can look like before contract award.
7. [Weak vs Strong Supplier Answers](../resources/worked-examples/weak-vs-strong-supplier-answers.md)  
