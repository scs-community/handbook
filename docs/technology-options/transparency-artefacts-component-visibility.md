...
Transparency artefacts may support:
...
| Acceptance | Review whether supplied artefacts match the product, version, and acceptance scope |
...
- **Source/version note:** Cite the artefact format, version, scope, generation tool or process, and product or release binding.

### SPDX

- **Assurance role:** Provides a software bill of materials and software supply-chain artefact format used for software component transparency.
...
- **Mapping confidence:** Direct for software transparency artefacts; supporting for vulnerability and procurement workflows.
- **Source/version note:** Cite the official SPDX source and the specific SPDX version used by an artefact. SPDX is described by the project as ISO/IEC 5962:2021.
...
- **Mapping confidence:** Direct for transparency artefacts; supporting for vulnerability and assurance workflows.
...
Transparency artefacts can support supplier questions, product acceptance, vulnerability analysis, dependency review, audit preparation, and customer assurance. They can also give update and monitoring workflows a structured starting point.
...
- exception handling for missing, incomplete, stale, or contradictory artefacts.
...
- artefact generation and approval records.

## Verification considerations

Verification should check whether the artefact is bound to the right product and version, whether the scope is clear, whether supplier and sub-tier coverage is explained, whether vulnerability status is current, and whether the artefact can be traced to a controlled generation or approval process.
...
- What transparency artefacts are available, and what product, version, or service do they cover?
