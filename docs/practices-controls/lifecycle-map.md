...
|---|---|---|---|---|
| Design | What trust assumptions and controls are required? | Missing threat model, unclear trust boundaries, unmanaged supplier assumptions | Threat model, security requirements, component criteria | [Attack & Failure Modes](../requirements/attack-failure-modes.md) |
