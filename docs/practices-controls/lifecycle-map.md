...
|---|---|---|---|---|
| Design | What trust assumptions and controls are required? | Missing threat model, unclear trust boundaries, unmanaged supplier assumptions | Threat model, security requirements, component criteria | [Attack & Failure Modes](../standards-threats/attack-failure-modes.md) |
